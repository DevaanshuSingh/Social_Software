            ...
            <form action="register.php" method="POST" enctype="multipart/form-data">
                <div class="single col-12">
                    <div class="mb-3 col-6">
                        ...
                        <input type="text" class="form-control" id="full-name" name="full-name" placeholder="Name" required>
                    </div>
                    <div class="mb-3 col-6">
                        <label for="user-name" class="form-label">Enter User Name/Short Name</label>
                        <input type="text" class="form-control" id="user-name" name="user-name" placeholder="Short Name" required>
                    </div>
                </div>
                ...
                <div class="single col-12">
                    <div class="mb-3 col-6">
                        ...
                        <input type="text" class="form-control" id="intrests" name="intrests" placeholder="Your Intrests" required>
                    </div>
                    <div class="mb-3 col-6">
                ...
                <div class="single"><button type="submit" class="btn">Register</button></div>
            </form>
        </div>
