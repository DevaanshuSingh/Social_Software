...
<body>
  <nav class="nav-container w-100 d-flex align-tems-center justify-content-center fixed-top">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
              <a class="nav-link btn btn-success text-warning" href="signUp.php">SIGN UP</a>
            </li>
          </ul>
        </div>
      </div>
